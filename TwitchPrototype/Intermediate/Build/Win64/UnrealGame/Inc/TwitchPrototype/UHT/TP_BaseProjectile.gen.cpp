...
// End Cross Module References
	DEFINE_FUNCTION(ATP_BaseProjectile::execGetProjectileMovement)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	{
		struct TP_BaseProjectile_eventGetProjectileMovement_Parms
		{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ATP_BaseProjectile_GetProjectileMovement_Statics::NewProp_ReturnValue_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ATP_BaseProjectile_GetProjectileMovement_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000080588, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(TP_BaseProjectile_eventGetProjectileMovement_Parms, ReturnValue), Z_Construct_UClass_UProjectileMovementComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ATP_BaseProjectile_GetProjectileMovement_Statics::NewProp_ReturnValue_MetaData), Z_Construct_UFunction_ATP_BaseProjectile_GetProjectileMovement_Statics::NewProp_ReturnValue_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ATP_BaseProjectile_GetProjectileMovement_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ATP_BaseProjectile_GetProjectileMovement_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ATP_BaseProjectile_GetProjectileMovement_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/TP_BaseProjectile.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ATP_BaseProjectile_GetProjectileMovement_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ATP_BaseProjectile, nullptr, "GetProjectileMovement", nullptr, nullptr, Z_Construct_UFunction_ATP_BaseProjectile_GetProjectileMovement_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ATP_BaseProjectile_GetProjectileMovement_Statics::PropPointers), sizeof(Z_Construct_UFunction_ATP_BaseProjectile_GetProjectileMovement_Statics::TP_BaseProjectile_eventGetProjectileMovement_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x40020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ATP_BaseProjectile_GetProjectileMovement_Statics::Function_MetaDataParams), Z_Construct_UFunction_ATP_BaseProjectile_GetProjectileMovement_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ATP_BaseProjectile_GetProjectileMovement_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ATP_BaseProjectile_GetProjectileMovement_Statics::TP_BaseProjectile_eventGetProjectileMovement_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_ATP_BaseProjectile_GetProjectileMovement()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ATP_BaseProjectile_GetProjectileMovement_Statics::FuncParams);
		}
	...
	struct Z_CompiledInDeferFile_FID_Github_Unreal_Projects_Twitch_Project_TwitchPrototype_Source_TwitchPrototype_Public_TP_BaseProjectile_h_Statics
	{
